  ...
  render() {
    return (
      <div className="text-center">
        <h2 className="pt-3 my-5">DA RULES</h2>
        <ul className="list-group">
          ...
          <li className="my-1">However, the last person also has to think of a final answer!</li>
          <li className="my-1">If they can't, they lose too!</li>
          <li className="my-1">Remember, articles (the, an, a) don't count!</li>
        </ul>
      </div>
    )
  }
